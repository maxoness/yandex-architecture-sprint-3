...
- #### домен **Управление системами отопления в домах**
  - поддомен **Взаимодействие с пользователями**
    - контекст **Отображение состояния систем отопления в домах**
    - контекст **Получение команд управления системами отопления в домах от Пользователей**
...
- #### домен **Мониторинг температуры в домах**
  - поддомен **Взаимодействие с пользователями**
  ...
  - поддомен **Взаимодействие с датчиками температуры**
    ...
    - контекст **Сохранение полученных показаний температуры в домах**
- ##### домен **Администрирование систем отопления в домах**
  - поддомен **Администрирование систем отопления в домах**
    -  контекст **Подключение систем отопления в домах к Системе**
...
- ##### домен **Администрирование пользователей и специалистов**
  ...
  - поддомен **Аутентификационные данные пользователей**
    - контекст **Управление аутентификационными данными пользователей** 
